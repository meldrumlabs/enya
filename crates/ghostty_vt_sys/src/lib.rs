//! FFI bindings to the Ghostty virtual terminal library.
//!
//! This crate provides raw C bindings to ghostty's terminal emulator core.
//! For a safe Rust interface, use the `ghostty_vt` crate instead.
