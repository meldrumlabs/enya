...
const TerminalHandle = struct {
    ...
    fn init(alloc: Allocator, cols: u16, rows: u16) !*TerminalHandle {
        return initWithScrollback(alloc, cols, rows, 100_000); // 100k lines default
    }

    fn initWithScrollback(alloc: Allocator, cols: u16, rows: u16, max_scrollback: usize) !*TerminalHandle {
