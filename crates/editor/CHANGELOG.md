...
- **Mobile browser detection**: On WASM, mobile browsers are now detected via user-agent and viewport width, and shown a friendly "desktop browser required" message instead of loading the full app.
